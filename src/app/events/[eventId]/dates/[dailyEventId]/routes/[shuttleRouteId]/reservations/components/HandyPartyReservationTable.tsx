...
import { handyPartyReservationColumns } from '../table.type';
...
const HandyPartyReservationTable = ({
  eventId,
  dailyEventId,
  shuttleRouteId,
}: Props) => {
  ...
  const reservationTable = useTable({
    columns: handyPartyReservationColumns,
...
export default HandyPartyReservationTable;
