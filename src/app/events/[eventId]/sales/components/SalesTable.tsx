        ...
        dailyEventsWithRoutesWithSales
          ...
          .map((dailyEventWithRoutesWithSales) => {
            ...
            const totalVehicleCount = routesWithSales.reduce(
              (sum, routeWithSales) => {
                return (
                  sum + (vehicleCounts[routeWithSales.shuttleRouteId] || 0)
                );
              },
              0,
            );

            const totalRowRouteWithSales: RouteWithSales =
              routesWithSales.reduce(
                (acc, routeWithSales) => {
                  return {
                    ...acc,
                    ...
                    totalPassengerCount:
                      acc.totalPassengerCount +
                      routeWithSales.totalPassengerCount,
